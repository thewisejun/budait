...
<div class="gridContainer">
      ...
      <div class="div previousStep"> 
        ...
        <a href='cart.php'><p>Previous Step   </p></a>
      </div>
      <form action="cart_updated.php" id="paymentForm" method="POST">
        <h6>Payment Details</h6>

        <?php if (isset($_POST['submit'])) {
        $email =  $_POST['email'];
        $home =  $_POST['houseaddress'];
        $myaddress= $_POST['myhome'];    
        $_SESSION["houseaddress"]=$home;
        $_SESSION["email"]=$email;
        $_SESSION['myhome'] = $myaddress;
        ...
        ?>
        <div class="inputCon" id="name" data-top="Email Address">
          <input type="email" name="email" required placeholder="example@gmail.com"/>
        </div>
        <div class="inputCon" id="cardNum" data-top="House Address" title = "house address">
          <input type="text" name="myhome" required placeholder="12 house av , New york"/>
        </div>
       
        <div class="inputCon" id="validYear" data-top="DOB">
          <input type="text" required placeholder="<?php echo  $_SESSION["dob"]; ?>" readonly/>
        </div>
        <div class="inputCon" id="cvv" data-top="Amount USD">
          <input type="text" required placeholder="$<?php echo  $_SESSION["amount"];?>" readonly/>
        </div>
